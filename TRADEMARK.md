...
The source code is available under the license in [LICENSE](LICENSE). That license covers the code only. It does not grant any right to use the marks, and this policy does not change the license.
...
The logo files in this repository are provided so that the software and its documentation display the logo. They are not licensed under [LICENSE](LICENSE), and this policy applies to them.
